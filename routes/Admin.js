...
const { createMedia, deleteMedia, getAllMedia, deleteAllMedia } = require("../controllers/Media");
...
router.route("/media/delete/all/images").delete(isAuthenticated, isAuthorizedAdmin, deleteAllMedia)
